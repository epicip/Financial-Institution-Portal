                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg py-0">
                    ...
                    <div class="dropdown-body py-1">
                        <ul class="list-unstyled dropdown-list">
                            <li>
                                <a class="dropdown-item fz-14px d-flex align-items-center gap-2 px-5" href="<?= base_url('users/change_password') ?>">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li>
                                <a class="dropdown-item fz-14px d-flex align-items-center gap-2 px-5" href="<?= base_url('logout') ?>">
